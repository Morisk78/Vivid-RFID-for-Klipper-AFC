...
class RFIDDict:
    ...
    bed_temperature_min: int = field(init=False)
    bed_temperature_max: int = field(init=False)
    ...
    _fields = {
        ...
        "bed_temperature_min": (18, 12, 4),
        "bed_temperature_max": (18, 16, 4),
...
class MFRC522:
    ...
    def write(self):
        data = {
            ...
            "bed_temperature_min": 25,
            "bed_temperature_max": 60,
